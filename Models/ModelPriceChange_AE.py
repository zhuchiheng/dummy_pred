...
class ModelPriceChange:
    def __init__(self):
        ...
        encoded = Dense(150, activation='relu', name=name+"encoder_1")(input_data)
        encoded = Dense(120, activation='relu', name=name+"encoder_2")(encoded)
        ...
        decoded = Dense(120, activation='relu', name=name+"decoder_3")(decoded)
        decoded = Dense(150, activation='relu', name=name+"decoder_4")(decoded)
