...
class ModelPriceVec:
    def __init__(self):
        ...
        encoded = Dense(256, activation='relu', name=name+"encoder_1")(input_data)
        encoded = Dense(128, activation='relu', name=name+"encoder_2")(encoded)
        encoded = Dense(80, activation='relu', name=name+"encoder_3")(encoded)
        ...
        decoded = Dense(80, activation='relu', name=name+"decoder_2")(decoded)
        decoded = Dense(128, activation='relu', name=name+"decoder_3")(decoded)
        decoded = Dense(256, activation='relu', name=name+"decoder_4")(decoded)
