...
class ModelMACD:
    def __init__(self):
        ...
        encoded = Dense(80, activation='relu', name=name+"encoder_1")(input_data)
        encoded = Dense(40, activation='relu', name=name+"encoder_2")(encoded)
        encoded = Dense(20, activation='relu', name=name+"encoder_3")(encoded)
        encoder_output = Dense(encoded_dim, name=name+"dense_1")(encoded)

        decoded = Dense(20, activation='relu', name=name+"decoder_1")(encoder_output)
        decoded = Dense(40, activation='relu', name=name+"decoder_2")(decoded)
        decoded = Dense(80, activation='relu', name=name+"decoder_3")(decoded)
        decoded = Dense(data_dim, activation='relu', name=name+"output")(decoded)
