...
raw_line = plt.plot(list(range(-prediction_step, -prediction_step + df.shape[0])), df[col].values, color='b')
result_line = plt.plot(list(range(result.shape[0])), result.values, color='pink',
                       alpha=0.95)
